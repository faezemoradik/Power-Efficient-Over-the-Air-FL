...
def get_parameter():
  ...
  parser.add_argument("-delta",default=6.0,type=float,help="a constant in the PoMFL")
  parser.add_argument("-alpha",default=0.5,type=float,help="a constant in the PoMFL")
  parser.add_argument("-beta",default=0.5,type=float,help="a constant in the PoMFL")
  parser.add_argument("-MSE_bound",default=0.5,type=float,help="MSE Bound in Bounded MSE method")
